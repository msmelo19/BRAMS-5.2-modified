  ...
  subroutine filltab_cuforc_sh(cuforc, cuforcm,imean, m1, m2, m3, ng)
    ...
    integer(kind=i8) :: npts
     ...
     if (associated(cuforc%lsfth))  &
         call InsertVTab(cuforc%lsfth,cuforcm%lsfth,ng, npts, imean, 'lsfth_sh :3:hist:mpti:mpt3')

     if (associated(cuforc%lsfrt))  &
         call InsertVTab(cuforc%lsfrt,cuforcm%lsfrt,ng, npts, imean, 'lsfrt_sh :3:hist:mpti:mpt3')
  ...
  subroutine filltab_cuforc(cuforc, cuforcm,imean, m1, m2, m3, ng)
    ...
    integer(kind=i8) :: npts
     ...
     if (associated(cuforc%lsfth))  &
         ...
         ,ng, npts, imean,  &
         'lsfth :3:hist:mpti:mpt3')

     if (associated(cuforc%lsfrt))  &
         call InsertVTab (cuforc%lsfrt,cuforcm%lsfrt &
         ,ng, npts, imean,  &
         'lsfrt :3:hist:mpti:mpt3')
