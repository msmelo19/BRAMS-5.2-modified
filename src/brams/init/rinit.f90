...
101  format('  NW LAT/LON      NE LAT/LON (DEG)= '  &
     ...
     call xy_ll(latCenter,lonCenter,platn(ngr),plonn(ngr)  &
          ,centx,centy)
     write(6,102)latCenter,lonCenter
