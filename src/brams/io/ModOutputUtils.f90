...
contains
  ...
  subroutine GetVarFromMemToOutput_2D (varName, ngrd, arrayOut)
    ...
    character(len=*), parameter :: h="**(GetVarFromMemToOutput_2D)**"
    ...
    if (.not. associated(vtabPtr)) then
       call fatal_error(h//" var "//trim(varName)//" not found in vtab_r")
    end if
  ...
  subroutine GetVarFromMemToOutput_3D (varName, ngrd, arrayOut)
    ...
    character(len=*), parameter :: h="**(GetVarFromMemToOutput_3D)**"
    integer :: i, j, k
    integer :: n1, n2, n3
  ...
  subroutine GetVarFromMemToOutput_4D (varName, ngrd, arrayOut)
    ...
    character(len=8) :: c0
    character(len=*), parameter :: h="**(GetVarFromMemToOutput_4D)**"
