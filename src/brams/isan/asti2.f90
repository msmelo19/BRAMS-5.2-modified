...
559 format(/'   Acquiring rawindsonde input file    ',A)
  call rams_f_open(4,inrawi(1:len_trim(inrawi)),'FORMATTED','OLD','READ',0)
...
559 format(/'   Acquiring surface input file    ',A40)
  call rams_f_open(4,insrfce(1:len_trim(insrfce)),'FORMATTED','OLD','READ',0)
