...
!--(DMK-CCATT-INI)----------------------------------------------------------------
  !srf-chem
!  integer, parameter :: nlevshadoz=1000
!  integer i,levshadoz(nlevshadoz)
!  real o3shadoz(nlevshadoz)
!  logical L1
  !srf-chem
!--(DMK-CCATT-FIM)----------------------------------------------------------------
...
!    
!     if(spc_name(nvar-5)=='O3') then
!      INQUIRE(FILE='O3_shadoz_feb2004.txt',EXIST=L1)!
!
!      IF(L1) then
!       open (unit=93,file='O3_shadoz_feb2004.txt',status='old')
!       print*,'=================================================='
!       print*,'using SHADOZ Ozone'       
!        do i=1,nlevshadoz
!         read(93,*,end=11) levshadoz(i),O3shadoz(i)
!         print*, levshadoz(i),O3shadoz(i)
!        enddo
!      11 close(93)
!     endif
