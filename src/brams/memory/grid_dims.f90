...
module grid_dims
  ...
  character(len=*), parameter :: BRAMS_version="BRAMS version 5.01 (http://brams.cptec.inpe.br)"
  ...
  integer, parameter :: nxpmax=2000 !1000 !303
  integer, parameter :: nypmax=2000 !1000 !303
  integer, parameter :: nzpmax=132
  integer, parameter :: nzgmax=20
  integer, parameter :: maxsclr=150
  integer, parameter :: maxhp=2000 !1000
  integer, parameter :: maxdim=2000 !1000 !303
  ...
  integer, parameter :: maxmach=14400 !64
  ...
  integer, parameter :: maxsstfiles=maxfiles !2000
  integer, parameter :: maxndvifiles=maxfiles  !2000
