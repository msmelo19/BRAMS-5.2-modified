...
contains
  ...
  subroutine CreateAcousticSendRecvU(&
    ...
    vTabPtr => null()
    call GetVTabEntry("UP", gridId, vTabPtr)
  ...
  subroutine CreateAcousticSendRecvV(&
    ...
    vTabPtr => null()
    call GetVTabEntry("VP", gridId, vTabPtr)
  ...
  subroutine CreateAcousticSendRecvP(&
    ...
    vTabPtr => null()
    call GetVTabEntry("PP", gridId, vTabPtr)
  ...
  subroutine CreateAcousticSendRecvWP(&
    ...
    vTabPtr => null()
    call GetVTabEntry("WP", gridId, vTabPtr)
  ...
  subroutine CreateSendRecvDn0u(&
    ...
    vTabPtr => null()
    call GetVTabEntry("DN0U", gridId, vTabPtr)
  ...
  subroutine CreateSendRecvDn0v(&
    ...
    vTabPtr => null()
    call GetVTabEntry("DN0V", gridId, vTabPtr)
  ...
  subroutine CreateG3DSendRecv(&
    ...
    if (g3d_spread == 1) then
       ...
       vTabPtr => null()
       call GetVTabEntry("TTENS", gridId, vTabPtr)
       ...
       vTabPtr => null()
       call GetVTabEntry("QVTTENS", gridId, vTabPtr)
    ...
    if (g3d_smoothh == 1) then
       ...
       vTabPtr => null()
       call GetVTabEntry("THSRC", gridId, vTabPtr)
       ...
       vTabPtr => null()
       call GetVTabEntry("RTSRC", gridId, vTabPtr)
