...
module node_mod
  ...
  integer, public :: mxp                !#x points (with ghost zone) on sub-domain
  integer, public :: myp                !#y points (with ghost zone) on sub-domain
  integer, public :: mzp                !#z points (with ghost zone) on sub-domain
