...
!==========================================================================
! ----- print Output ---------------------------------------------
 print*,"begin of setcoef";call flush(6)
      print*,"1", laytrop        ! tropopause layer index
       print*,"2", jp(1:nlayers)          ! 
                                                      !    Dimensions: (nlayers)
       print*,"3", jt(1:nlayers)          !
                                                      !    Dimensions: (nlayers)
       print*,"4", jt1(1:nlayers)         !
                                                      !    Dimensions: (nlayers)
       print*,"5", planklay(1:nlayers,:)     ! 
                                                      !    Dimensions: (nlayers,nbndlw)
       print*,"6", planklev(1:nlayers,:)    ! 
                                                      !    Dimensions: (0:nlayers,nbndlw)
       print*,"7", plankbnd(:)       ! 
                                                      !    Dimensions: (nbndlw)
       print*,"8", dplankbnd_dt(:)   ! 
                                                      !    Dimensions: (nbndlw)
call flush(6)
       print*,"9", colh2o(1:nlayers)         ! column amount (h2o)
                                                      !    Dimensions: (nlayers)
       print*,"10", colco2(1:nlayers)         ! column amount (co2)
                                                      !    Dimensions: (nlayers)
       print*,"11", colo3(1:nlayers)          ! column amount (o3)
                                                      !    Dimensions: (nlayers)
       print*,"12", coln2o(1:nlayers)         ! column amount (n2o)
                                                      !    Dimensions: (nlayers)
       print*,"13", colco(1:nlayers)          ! column amount (co)
                                                      !    Dimensions: (nlayers)
       print*,"14", colch4(1:nlayers)         ! column amount (ch4)
                                                      !    Dimensions: (nlayers)
       print*,"15", colo2(1:nlayers)          ! column amount (o2)
                                                      !    Dimensions: (nlayers)
       print*,"16", colbrd(1:nlayers)         ! column amount (broadening gases)
                                                      !    Dimensions: (nlayers)
call flush(6)
       print*,"17", indself(1:nlayers)
                                                      !    Dimensions: (nlayers)
       print*,"18", indfor(1:nlayers)
                                                      !    Dimensions: (nlayers)
       print*,"19", selffac(1:nlayers)
                                                      !    Dimensions: (nlayers)
       print*,"20", selffrac(1:nlayers)
                                                      !    Dimensions: (nlayers)
       print*,"21", forfac(1:nlayers)
                                                      !    Dimensions: (nlayers)
       print*,"22", forfrac(1:nlayers)
                                                      !    Dimensions: (nlayers)

       print*,"23", indminor(1:nlayers)
                                                      !    Dimensions: (nlayers)
       print*,"24", minorfrac(1:nlayers)
                                                      !    Dimensions: (nlayers)
       print*,"25", scaleminor(1:nlayers)
                                                      !    Dimensions: (nlayers)
       print*,"26", scaleminorn2(1:nlayers)
                                                      !    Dimensions: (nlayers)
call flush(6)
       print*,"27", &                 !
                       fac00(1:nlayers), fac01(1:nlayers), &          !    Dimensions: (nlayers)
                       fac10(1:nlayers), fac11(1:nlayers) 
                                                        
       print*,"28", &                 !
                       rat_h2oco2(1:nlayers),rat_h2oco2_1(1:nlayers), &
                       rat_h2oo3(1:nlayers),rat_h2oo3_1(1:nlayers), & !    Dimensions: (nlayers)
                       rat_h2on2o(1:nlayers),rat_h2on2o_1(1:nlayers), &
                       rat_h2och4(1:nlayers),rat_h2och4_1(1:nlayers), &
                       rat_n2oco2(1:nlayers),rat_n2oco2_1(1:nlayers), &
                       rat_o3co2(1:nlayers),rat_o3co2_1(1:nlayers)
print*,"end of setcoef";call flush(6)
!==========================================================================
