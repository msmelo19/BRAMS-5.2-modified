...
subroutine nakanishi(m1,m2,m3,m4,ia,iz,ja,jz,jd,tkep,tket,vt3dd,vt3de,vt3dh,vt3di          &
                    ...
                    ,patch_area,sflux_u,sflux_v,sflux_t,flpu_R,flpv_R,flpw_R,kpbl,pblhgt,lmo     &
                    ,tl,sigw)
   !---------------------------------------------------------------------------------------!
...
!------------------------------------------------------------------------------------------!
subroutine nakanishi_light(m1,m2,m3,m4,ia,iz,ja,jz,jd,tkep,tket,vt3dd,vt3de,vt3dh,vt3di    &
                    ,vt3dj,scr1,rtgt,theta,rv,rtp,dn0,up,vp,vegz0,patchz0,tstar,ustar      &
                    ,patch_area,sflux_u,sflux_v,sflux_t,flpu_R,flpv_R,flpw_R, &
		    !kpbl,pblhgt,!srf
		    lmo     )
                    !,tl,sigw)!srf
   !---------------------------------------------------------------------------------------!
   ...
   !real     , intent(inout) , dimension(m2,m3)    :: pblhgt
   real     , intent(inout) , dimension(m2,m3)    :: lmo
   real     , intent(inout) , dimension(m1,m2,m3) :: vt3dh, scr1 !, tl, sigw
   real     , intent(inout) , dimension(m1,m2,m3) :: vt3di,tket
   !----- Internal variables --------------------------------------------------------------!
   integer                                        :: i,j,k,p,k2u,k2um1,k2v,k2vm1,k2w 
   ...
   return
end subroutine nakanishi_light
!==========================================================================================!
!==========================================================================================!
